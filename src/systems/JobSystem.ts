...
import { gfxMap, pathMap, pathIdx } from '../ecs/world'
...
export function jobSystem(
  ...
  jobQueue: JobQueue,
  worldMap: WorldMap,
  onResourceDied: (eid: number) => void,
): void {
  ...
  for (const eid of eids) {
    ...
    if (state !== ColonistStateId.Working) continue
